...
# plot() is function in R, and 'cars' is a built-in dataset in R
...
To add a new code chunk, press *Ctrl+Alt+I* (*Cmd+Option+I* on Mac), or click the *Insert* button at the top of this document, then select *R*. R Markdown will add a new, empty chunk at your cursor's location.
...
# run and then press Control + Enter (Cmd + Enter on 
# Macs). If you do not highlight any code, R will 
...
Click the *knit* button at the top of this document or press *Ctrl+Shift+K* (*Cmd+Shift+K* on Macs) to render the finished report. The RStudio IDE will open the report so you can see its contents. For now, our reports will be HTML files. Try clicking *Knit* now.

Good job! You'll learn more about R Markdown throughout the class!
